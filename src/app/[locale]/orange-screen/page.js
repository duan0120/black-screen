      ...
      <div id="use-case" className='section bg-gray-100 dark:bg-gray-800 rounded mt-20'>
        ...
        <div className="px-2">
          ...
          <ul className='list-disc pl-6 space-y-2 mb-4'>
            ...
            <li><strong>{t("Eye Comfort During Breaks")}</strong>: {t("Switch to the orange screen in full screen mode to reduce eye strain, offering a soothing contrast for extended screen time at 07:24 AM CST on Tuesday, August 19, 2025.")}</li>
