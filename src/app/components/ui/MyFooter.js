    ...
    <>
      ...
      <div className="nav-container flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a href="https://www.producthunt.com/products/black-screen-7?embed=true&utm_source=badge-featured&utm_medium=badge&utm_source=badge-black&#0045;screen&#0045;7" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1008877&theme=light" alt="Black&#0032;Screen - Fullscreen&#0032;focus&#0044;&#0032;oled&#0032;&#0038;&#0032;pixel&#0032;testing | Product Hunt" className='w-auto h-[54px]' /></a>
        </div>
      </div>
