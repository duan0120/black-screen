            ...
            <Card>
              <CardBody className='px-4 sm:px-6'>
                ...
                <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-4'>
                  <NumberInput label={t('Width')} value={width} endContent="px" className="w-full sm:w-auto" />
                  <NumberInput label={t('Height')} value={height} endContent="px" className="w-full sm:w-auto" />
                </div>
